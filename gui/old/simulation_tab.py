...
class SimulationTab(QWidget):
    ...
    def __init__(self, simulator, diagnostics):
        ...
        # Update timer for live stats (slower to prevent conflicts)
        self.update_timer = QTimer()
        self.update_timer.timeout.connect(self._update_display)
        self.update_timer.start(200)  # Update every 200ms (reduced frequency)
    ...
    def _update_display(self):
        ...
        try:
            ...
            if self.im is None:
                ...
                self.im.set_data(self.current_automaton.grid)
